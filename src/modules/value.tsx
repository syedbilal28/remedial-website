...
export const Value: React.FC<ValuesItem> = ({title, value}) => (
    <div className="grid grid-rows-3 grid-flow-col gap-4 p-1 text-left">
        <div className="p-1 w-full rounded-xl row-span-3">
            <CheckCircleFilled style={{ color: "#0A4BB3", fontSize: "40px" }} />
        </div>
        <div className="p-1 w-full rounded-xl col-span-2 text-white text-base font-bold leading-tight text-xl flex">
            <h2>{title}</h2>
        </div>
